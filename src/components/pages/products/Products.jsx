...
const ProductCard = ({
    ...
    const magnify = () => {
      ...
      const moveMagnifier = (e) => {
        ...
        requestAnimationFrame(() => {
          ...
          glass.style.transform = `translate(${x - w}px, ${y - h - 300}px)`;
  ...
  return (
    <div className={`relative flex flex-col md:flex-row items-center ${bgColor} shadow-lg rounded-lg p-4`}>
      <div
        ref={glassRef}
        className="absolute w-[180px] h-[180px] bg-white rounded-full border-2 shadow-lg cursor-none pointer-events-none"
      ...
      <img
        ...
        onMouseEnter={() => glassRef.current && (glassRef.current.style.visibility = "visible")}
        onMouseLeave={() => glassRef.current && (glassRef.current.style.visibility = "hidden")}
      />
